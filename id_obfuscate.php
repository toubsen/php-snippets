 ...
 * on your use case, you should choose the full HMAC size for security.
 * 
 * Additions:
 * This will just protect you from people trying to probe for ids to
...
class IdObfuscator {
    ...
    /**
     * @var int Length of the HMAC in Hex encoding
     */
    private $hmacLenHex = 0;
    
    /**
     * @var int Length of the HMAX in Base32 encoding
     */
...
echo "encoded: " . $idObf->encode(2) . "\n";
echo " deoded: " . $idObf->decode('6nu58tn5i3hpn2') . "\n";
